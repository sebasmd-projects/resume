...
export default function PythonReumeComponent() {
    return (
        <div className="col-md-6">
            ...
            <p align="justify">
                Soy un <strong>desarrollador Python</strong> con un enfoque en <strong>Django</strong> y <strong>Django REST Framework</strong>,
            ...
            <p align="justify">
                ...
                Estoy familiarizado con la biblioteca <strong>drf-yasg</strong>,
            ...
            <p align="justify">
                Tengo conocimiento de análisis de datos con las bibliotecas de <strong>NumPy</strong> y <strong>Pandas</strong>,
            ...
            <p align="justify">
                ...
                como <strong><span className={style.tooltip}>Celery<span className={style.tooltiptext}>Celery es una biblioteca de Python que se utiliza para realizar tareas en segundo plano o tareas programadas de manera asíncrona. Es ampliamente utilizada para la gestión de tareas asincrónicas en aplicaciones Django.</span>
                </span></strong>, ampliando aún más las posibilidades de los proyectos en los que contribuyo.
            </p>
            <p>
